...
TEMPLATE = app
SPL_BASE = $$PWD/../../../../../spl-base/StanfordCPPLib_2
...
!exists($$SPL_BASE/private/version.h) {
...
exists($$SPL_BASE/*.cpp) {
    SOURCES += $$SPL_BASE/*.cpp
}
SOURCES += $$SPL_BASE/collections/*.cpp
SOURCES += $$SPL_BASE/graphics/*.cpp
SOURCES += $$SPL_BASE/io/*.cpp
SOURCES += $$SPL_BASE/private/*.cpp
SOURCES += $$SPL_BASE/system/*.cpp
SOURCES += $$SPL_BASE/util/*.cpp
exists($$PWD/src/*.cpp) {
    SOURCES += $$PWD/src/*.cpp
}
...
HEADERS += $$SPL_BASE/collections/*.h
HEADERS += $$SPL_BASE/graphics/*.h
HEADERS += $$SPL_BASE/io/*.h
HEADERS += $$SPL_BASE/private/*.h
HEADERS += $$SPL_BASE/system/*.h
HEADERS += $$SPL_BASE/util/*.h
...
INCLUDEPATH += $$SPL_BASE/
INCLUDEPATH += $$SPL_BASE/collections/
INCLUDEPATH += $$SPL_BASE/graphics/
INCLUDEPATH += $$SPL_BASE/io/
INCLUDEPATH += $$SPL_BASE/system/
INCLUDEPATH += $$SPL_BASE/util/
INCLUDEPATH += $$PWD/src/
INCLUDEPATH += $$PWD/
