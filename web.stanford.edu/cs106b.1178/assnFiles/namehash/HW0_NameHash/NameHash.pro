...
TEMPLATE = app
# SPL_BASE = $$absolute_path(../../../../../spl-base/StanfordCPPLib_1)
SPL_BASE = $$PWD/../../../../../spl-base/StanfordCPPLib_1
...
SOURCES += $$SPL_BASE/stacktrace/*.cpp
exists($$PWD/src/*.cpp) {
    SOURCES += $$PWD/src/*.cpp
}
...
INCLUDEPATH += $$SPL_BASE/private/
INCLUDEPATH += $$SPL_BASE/stacktrace/
INCLUDEPATH += $$PWD/src/
INCLUDEPATH += $$PWD/
exists($$PWD/src/autograder/*.h) {
